...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestRG-221102104146036797"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "service" {
  ...
  name      = "acctestAM-221102104146036797"
...
resource "azapi_resource" "authorizationServer" {
  ...
  name      = "acctestauthsrv-221102104146036797"
...
resource "azapi_resource" "api" {
  ...
  parent_id = azapi_resource.service.id
  name      = "acctestapi-221102104146036797;rev=1"
  ...
  body = jsonencode({
    properties = {
      ...
      authenticationSettings = {
        oAuth2 = {
          authorizationServerId = azapi_resource.authorizationServer.name
          scope                 = "acctest"
        }
      }
      description = ""
