...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctest-dataprotection-221102104550892627"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "backupVault" {
  ...
  name      = "acctest-dataprotection-vault-221102104550892627"
...
resource "azapi_resource" "backupPolicy" {
  ...
  name      = "acctest-dbp-other-221102104550892627"
...
resource "azapi_resource" "backupPolicy2" {
  type      = "Microsoft.DataProtection/backupVaults/backupPolicies@2022-04-01"
  parent_id = azapi_resource.backupVault.id
  name      = "acctest-dbp-221102104550892627"
