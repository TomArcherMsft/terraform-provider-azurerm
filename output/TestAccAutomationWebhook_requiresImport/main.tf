...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestRG-auto-221018170319716130"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "automationAccount" {
  ...
  name      = "acctest-221018170319716130"
...
resource "azapi_resource" "webhook" {
  ...
  body = jsonencode({
    properties = {
      expiryTime = "2022-10-18T10:03:19Z"
      isEnabled  = true
      parameters = {}
      runOn      = ""
      runbook = {
      ...
      uri = "https://aa89a42f-b3b5-4e7d-a6b8-b7d2afd70c66.webhook.we.azure-automation.net/webhooks?token=qzfnWSFpCLZD24VZDSqcCsQEfakQypj78VhborsNo54%3d"
    }
  })
