...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestRG-auto-221018170052561378"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "automationAccount" {
  ...
  name      = "acctest-221018170052561378"
...
resource "azapi_resource" "webhook" {
  ...
  body = jsonencode({
    properties = {
      expiryTime = "2022-10-18T10:00:52Z"
      isEnabled  = true
      parameters = {}
      runOn      = ""
      runbook = {
      ...
      uri = "https://5ca96ed0-1619-495f-96af-17e1c3c2a19c.webhook.we.azure-automation.net/webhooks?token=OjaqCRUIRg3qkE1rg%2fkmWt0U%2bLK4jG%2b855ZSlGUbZvo%3d"
    }
  })
