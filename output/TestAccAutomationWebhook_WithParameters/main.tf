...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestRG-auto-221018170546461843"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "automationAccount" {
  ...
  name      = "acctest-221018170546461843"
...
resource "azapi_resource" "webhook" {
  ...
  body = jsonencode({
    properties = {
      expiryTime = "2022-10-18T10:05:46Z"
      isEnabled  = true
      parameters = {
        input = "parameter"
      }
      ...
      uri = "https://85b25655-9276-464b-8390-f710f8e60397.webhook.we.azure-automation.net/webhooks?token=4IThKAPbCWYOWE96om5B6Euqxnc9kdEy2r4oYSiBKnU%3d"
    }
  })
