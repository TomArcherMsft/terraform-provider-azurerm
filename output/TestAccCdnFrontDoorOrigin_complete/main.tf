...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestrg-cdn-afdx-221102104443213907"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "profile" {
  ...
  name      = "acctest-cdnfdprofile-221102104443213907"
  location  = "global"
  body = jsonencode({
    properties = {
...
resource "azapi_resource" "originGroup" {
  ...
  name      = "acctest-cdnfd-group-221102104443213907"
...
resource "azapi_resource" "origin" {
  ...
  name      = "acctest-cdnfdorigin-221102104443213907"
