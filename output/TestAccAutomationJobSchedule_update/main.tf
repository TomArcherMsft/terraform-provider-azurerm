...
resource "azapi_resource" "resourceGroup" {
  ...
  name      = "acctestRG-auto-221018164622049977"
  location  = "westeurope"
  body      = jsonencode({})
  tags      = {}
}
...
resource "azapi_resource" "automationAccount" {
  ...
  name      = "acctestAA-221018164622049977"
...
resource "azapi_resource" "schedule" {
  ...
  parent_id = azapi_resource.automationAccount.id
  name      = "acctestAS-221018164622049977"

  body = jsonencode({
    properties = {
      description = ""
      frequency   = "OneTime"
      startTime   = "2022-10-18T16:53:36.231662+08:00"
      timeZone    = "Etc/UTC"
    }
  })
...
resource "azapi_resource" "jobSchedule" {
  ...
  parent_id = azapi_resource.automationAccount.id
  name      = "c6c255f5-cbdd-4a99-bddf-3b1f70c67e13"
